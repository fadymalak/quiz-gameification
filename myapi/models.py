...
class User(AbstractUser):
    ...
    @cached_property
    def points(self):
        return self.anwsers.filter(user=self.id).aggregate(points=Sum("point"))[
            "points"
        ]
...
class Courses(models.Model):
    ...
    owner = models.ForeignKey(User, related_name="course", on_delete=models.CASCADE)
...
class Answer(models.Model):
    ...
    question = models.ForeignKey(
        Question, related_name="anwsers", on_delete=models.DO_NOTHING
    )
